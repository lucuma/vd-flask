...
def caps(text):
    ...
    try:
        ...
        if config.DEBUG:
            raise RuntimeError("Error in {% caps %} filter: The Python SmartyPants library isn't installed.")
        return text
...
def smartypants(text):
    ...
    try:
        ...
        if config.DEBUG:
            raise RuntimeError("Error in {% smartypants %} filter: The Python smartypants library isn't installed.")
        return text
    else:
...
def titlecase(text):
    ...
    try:
        ...
        if config.DEBUG:
            raise RuntimeError("Error in {% titlecase %} filter: The titlecase.py library isn't installed.")
        return text
    else:
